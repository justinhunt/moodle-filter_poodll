...
public static function fetch_general_items(){
   ...
   //html5 recorder settings.
	...
	$options = array('standard' => get_string('plain_recorder', 'filter_poodll'), 'burntrose' => get_string('burntrose_recorder', 'filter_poodll'), 'onetwothree' => get_string('onetwothree_recorder', 'filter_poodll'), 'gold'=>'Gold');
