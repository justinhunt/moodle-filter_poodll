...
class poodllpresets extends \admin_setting {
	...
	protected function fetch_presets(){
		...
		$(".filter_poodll_tabitem", $("#" + @@AUTOID@@)).each(function () {
		...
		$( "#" + @@AUTOID@@).tabs();';
					...
					case '8':
						...
						$presets['body']='<div id="@@AUTOID@@" class="filter_poodll_tabitem" title="@@title@@">';
		...
		<div>';
			...
			"text": "@@data@@"
					...
					case '12':
						...
						$presets['bodyend'] = '';
						$presets['body'] ='<a href="#" data-featherlight="#@@AUTOID@@"><div class="filter_poodll_ytl"><img src="http://img.youtube.com/vi/@@videoid@@/hqdefault.jpg" width="@@width@@" height="@@height@@"/ ></div></a>
		...
		<div  id="@@AUTOID@@"><iframe width="@@videowidth@@" height="@@videoheight@@" src="//www.youtube.com/embed/@@videoid@@?rel=0" frameborder="0" allowfullscreen></iframe></div>
						...
						$presets['script'] = '';
						$presets['style'] = '.filter_poodll_ytl img{display: block;}
		.filter_poodll_ytl { 
		position: relative; 
		...
		listbar: {
				...
				case '17':
						...
						$presets['bodyend'] = '';
						$presets['body'] ='<div class="filter_poodll_info">
			<i class="fa fa-info-circle"></i>
			@@text@@
		</div>';
						$presets['script'] = '';
						$presets['style'] = '.filter_poodll_info {
			margin: 10px 0px;
			padding:12px;
			color: #00529B;
		...
		.isa_info i {
			...
			vertical-align:middle;
				...
				case '18':
						...
						$presets['defaults'] = 'text="Your message goes here."';
						$presets['bodyend'] = '';
						$presets['body'] ='<div class="filter_poodll_warning">
			<i class="fa fa-warning"></i>
			@@text@@
		</div>';
						$presets['script'] = '';
						$presets['style'] = '.filter_poodll_warning {
			margin: 10px 0px;
			padding:12px;
			color: #9F6000;
		...
		.isa_warning i {
			...
			vertical-align:middle;
				...
				case '19':
						...
						$presets['defaults'] = 'text="Your message goes here."';
						$presets['bodyend'] = '';
						$presets['body'] ='<div class="filter_poodll_error">
			<i class="fa fa-times-circle"></i>
			@@text@@
		</div>';
						$presets['script'] = '';
						$presets['style'] = '.filter_poodll_error {
			margin: 10px 0px;
			padding:12px;
			color: #D8000C;
