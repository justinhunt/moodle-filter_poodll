var $runtime="dhtml";var $dhtml=true;var $as3=false;var $as2=false;var $swf10=false;var $j2me=false;var $debug=false;var $js1=true;var $backtrace=false;var $swf7=false;var $swf9=false;var $svg=false;var $swf8=false;var $mobile=false;var $profile=false;pmrpc=self.pmrpc=(function(){
...
var $6=lz.embed,$7="__lz"+$6.iframemanager.__counter++;if(typeof $0=="string"){
$6.iframemanager.__ownerbyid[$7]=$0
};var $8='javascript:""';var $9='lz.embed.iframemanager.__gotload("'+$7+'")';if($1==null||$1=="null"||$1=="")$1=$7;if($3==null||$3=="undefined"){
$3=document.body
};if(document.all){
var $a="<iframe name='"+$1+"' id='"+$7+"' src='"+$8+"' onload='"+$9+"' frameBorder='0'";if($2!=true)$a+=" scrolling='no'";$a+="></iframe>";var $b=document.createElement("div");$b.setAttribute("id",$7+"Container");$3.appendChild($b);$b.style.position="absolute";$b.style.display="none";$b.style.top="0px";$b.style.left="0px";$b.innerHTML=$a;var $c=document.getElementById($7)
}else{
var $c=document.createElement("iframe");$c.setAttribute("name",$1);$c.setAttribute("src",$8);$c.setAttribute("id",$7);$c.setAttribute("onload",$9);$c.setAttribute("tabindex","-1");if($2!=true)$c.setAttribute("scrolling","no");this.appendTo($c,$3)
};if($c){
this.__finishCreate($7,$0,$1,$2,$3,$4,$5)
}else{
this.__callqueue[$7]=[["__finishCreate",$7,$0,$1,$2,$3,$4,$5]];setTimeout('lz.embed.iframemanager.__checkiframe("'+$7+'")',10)
};return $7+""
...
};var $7=lz.embed,$8=$7.iframemanager.getFrame($0);if(!$8)return;if($8.appcontainer){
var $9=$7.getAbsolutePosition($8.appcontainer)
}else{
var $9={x:0,y:0}};if($1!=null&&!isNaN($1))$8.style.left=$1+$9.x+"px";if($2!=null&&!isNaN($2))$8.style.top=$2+$9.y+"px";if($3!=null&&!isNaN($3))$8.style.width=$3+"px";if($4!=null&&!isNaN($4))$8.style.height=$4+"px";if($5!=null){
$7.iframemanager.setVisible($0,$5)
};if($6!=null){
$7.iframemanager.setZ($0,$6)
}},setVisible:function($0,$1){
if(this.__callqueue[$0]){
this.__callqueue[$0].push(["setVisible",$0,$1]);return
};if(typeof $1=="string"){
$1=$1=="true"
};lz.embed.iframemanager.setStyle($0,null,"display",$1?"block":"none")
...
}};var $2=this.getFrameWindow($0);var $3;try{
$3=$2&&$2.location&&$2.location.href
}
catch($4){};var $5=$3||$1.src;if($5&&this.__srcbyid[$0]!==$5&&$5==='javascript:""'){
return
...
};var $2=lz.embed.iframemanager.getFrame($0);if(!$2)return;$1+=$2.__zoffset;lz.embed.iframemanager.setStyle($0,null,"zIndex",$1)
...
};$2.__owner=null;$2.appcontainer=null;if(document.all){
var $3=document.getElementById($0+"Container");if($3.parentNode){
...
var $2=iframemanager.getFrameWindow(id).document;if(!($2&&$2.valueOf))return
}
catch($3){
return
