...
}})();Class.make("LzDeclaredEventClass",["actual",void 0,"$lzsc$initialize",function($0){
switch(arguments.length){
case 0:
$0=null;
...
var $6=$5.owner instanceof LzSprite?$5.owner.owner:null;$1.kernel.__show($6)
};return false
}};return true
...
};var $5=LzSprite.__rootSprite.__LZdiv;var $6=[];if($2.fix_contextmenu){
$6.push($5,$5.style.display);var $7=$5.style.zIndex;$5.style.zIndex=-1000;var $8=LzSprite.__rootSprite.__LZclickcontainerdiv;var $9=$8.style.zIndex;$6.push($8,$8.style.display);$8.style.zIndex=-9999
};do{
var $a=document.elementFromPoint($3,$4);if(!$a){
break
}else{
var $b=$a.owner;if(!$b){

}else if($b.__contextmenu){
$1=$b.__contextmenu;break
}else if($2.ie_elementfrompoint&&$b.scrolldiv===$a){};$6.push($a,$a.style.display);$a.style.display="none"
}}while($a!==$5&&$a.tagName!="HTML");for(var $c=$6.length-1;$c>=0;$c-=2){
$6[$c-1].style.display=$6[$c]
};if($2.fix_contextmenu){
$5.style.zIndex=$7;$8.style.zIndex=$9
}}else{
var $d=($0.srcElement||$0.target).owner;if($d){
while($d.__parent){
if($d.__contextmenu){
var $e=$d.getMouse();if($e.x>=0&&$e.x<$d.width&&$e.y>=0&&$e.y<$d.height){
$1=$d.__contextmenu;break
}};$d=$d.__parent
}}};return $1
...
};div.onmouseup=LzSprite.__globalClickDispatcher;div.onmousedown=LzSprite.__globalClickDispatcher;div.onclick=LzSprite.__globalClickDispatcher;div.onmouseout=function($0){
...
$0=$0||window.event;if(!$0)return;if($0.button==2){
return LzMouseKernel.__handleContextMenu($0)
...
$0=$0||window.event;if(!$0)return;$0.cancelBubble=true;if($0.button==2){
return LzMouseKernel.__handleContextMenu($0)
...
return
};var $1=$0.target||$0.srcElement;var $2=$1&&$1.owner;var $3="on"+$0.type;if(LzSprite.quirks.ie_mouse_events){
if($3=="onmouseenter"){
$3="onmouseover"
...
this._clip=$1;this.__LZdiv.style.overflow=$1
}else{
return
};if($0.fix_clickable&&this.__LZclickcontainerdiv&&this.__LZclick){
this.__LZclick.style.overflow=$1
};if($0.fix_contextmenu&&this.__LZcontextcontainerdiv&&this.__LZcontext){
this.__LZcontext.style.overflow=$1
...
var $1=String($0).split("/")[0].split(" ");var $2=$1.length;if($2>4)$2=4;if($2==0)return;if($2<=1)$1[1]=$1[0];if($2<=3)$1[3]=$1[1];if($2<=2)$1[2]=$1[0];for(var $3=0;$3<$2;$3++){
$1[$3]=parseFloat($1[$3])
