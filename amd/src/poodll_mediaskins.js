...
define(['jquery', 'core/log',
    ...
    'filter_poodll/poodll_freshmediaskin'], function($, log, baseskin, onetwothreeskin, goldskin, bmrskin, shadowskin,splitskin, fluencybuilderskin, readaloudskin,onceskin, freshskin) {
