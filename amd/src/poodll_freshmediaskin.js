       ...
       update_status: function(controlbarid){
        ...
        set_visual_mode: function(mode, controlbarid){
           ...
           switch(mode){
               ...
               case 'initmode':
                    ...
                    ip.controlbar.stopbutton.attr('class', 'poodll_stop-recording_fresh poodll_fresh_stop_btn bmr_disabled');
        ...
        prepare_controlbar: function(element,controlbarid, preview,resource, mediatype) {
                ...
                controls += '<div class="poodll_fresh_musik_line">' +
                                ...
                                '<canvas id="' + controlbarid + '_playcanvas" width="300" height="50"></canvas>' +
                            ...
                            '<div class="poodll_fresh_control">' +
                               ...
                               // '<div class="poodll_stop-recording_fresh poodll_fresh_pause_btn bmr_disabled"></div>' +
           ...
           /*     controls +=  '<button type="button" class="poodll_mediarecorder_button_fresh poodll_start-recording_fresh"><i class="fa ' + record_icon + '" aria-hidden="true"></i></button>';
                ...
                var controlbar = {
                    ...
                    stopbutton: $('#' + controlbarid + ' .poodll_stop-recording_fresh'),
