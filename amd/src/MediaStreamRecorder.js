...
define(['jquery','core/log'], function($, log) {
    ...
    log.debug('PoodLL mediastream recorder: initialising');
    ...
    return {
        ...
        IsChrome: function () {
            return (!this.IsEdge() && !!navigator.webkitGetUserMedia);
        },
        ObjectStore: {},



        fetch_mediaRecorder: function (stream) {

            if (typeof this.MediaStreamRecorder !== 'undefined') {
                this.MediaStreamRecorder.MultiStreamRecorder = this.MultiStreamRecorder;
            }
...
// Cross-Browser-Declarations.js
        ...
        // WebAudio API representer
            ...
            // (used to handle stuff like http://goo.gl/xmE5eg) issue #129
            // ObjectStore.js
            this.ObjectStore.AudioContext = AudioContext;
            ...
            if (typeof this.MediaStreamRecorder !== 'undefined') {
                this.MediaStreamRecorder.GifRecorder = this.GifRecorder;
            }


            if (typeof this.MediaStreamRecorder !== 'undefined') {
                this.MediaStreamRecorder.MediaRecorderWrapper = this.MediaRecorderWrapper;
            }


            if (typeof this.MediaStreamRecorder !== 'undefined') {
                this.MediaStreamRecorder.PlainMediaRecorderWrapper = this.PlainMediaRecorderWrapper;
            }

            if (typeof this.MediaStreamRecorder !== 'undefined') {
                this.MediaStreamRecorder.StereoAudioRecorder = this.StereoAudioRecorder;
            }

            if (typeof this.MediaStreamRecorder !== 'undefined') {
                this.MediaStreamRecorder.StereoAudioRecorderHelper = this.StereoAudioRecorderHelper;
            }

            if (typeof this.MediaStreamRecorder !== 'undefined') {
                this.MediaStreamRecorder.WhammyRecorder = this.WhammyRecorder;
            }

            if (typeof MediaStreamRecorder !== 'undefined') {
                this.MediaStreamRecorder.WhammyRecorderHelper = this.WhammyRecorderHelper;
            }

            if (typeof this.MediaStreamRecorder !== 'undefined') {
                this.MediaStreamRecorder.Whammy = this.Whammy;
            }

            return this.MediaStreamRecorder(stream);
        },
...
// https://github.com/gsroth
        ...
        mergeProps: function(mergein, mergeto) {
        ...
        MediaStreamRecorder: function (mediaStream) {
            if (!mediaStream) {
            ...
            this.start = function (timeSlice) {
                ...
                if (typeof MediaRecorder !== 'undefined') {
                    Recorder = PlainMediaRecorderWrapper;
                ...
                mediaRecorder = self.mergeProps(mediaRecorder, this);
            ...
            this.save = function (file, fileName) {
                if (!file) {
                    ...
                    ConcatenateBlobs(mediaRecorder.blobs, mediaRecorder.blobs[0].type, function (concatenatedBlob) {
                        self.invokeSaveAsDialog(concatenatedBlob);
                    });
                    return;
                }
                self.invokeSaveAsDialog(file, fileName);
            };
        ...
        isMediaRecorderCompatible: function () {
...
// MediaRecorder.js
        ...
        MediaRecorderWrapper: function (mediaStream) {
            var self = this;
            var IsEdge = this.IsEdge();
            var IsOpera = this.IsOpera();
            var IsChrome = this.IsChrome();
     ...
     * });
        ...
        PlainMediaRecorderWrapper: function (mediaStream) {
            var self = this;
            var IsEdge = this.IsEdge();
            var IsOpera = this.IsOpera();
            var IsChrome = this.IsChrome();
     ...
     * });
        ...
        },//end of PlainMediaRecorder Function

// ======================
// StereoAudioRecorder.js
        StereoAudioRecorder: function (mediaStream) {
            // void start(optional long timeSlice)
            // timestamp to fire "ondataavailable"
            this.start = function (timeSlice) {
...
// MultiStreamRecorder.js
        ...
        MultiStreamRecorder: function (arrayOfMediaStreams) {
...
// source code from: http://typedarray.org/wp-content/projects/WebAudioRecorder/script.js
        ...
        StereoAudioRecorderHelper: function (mediaStream, root) {
...
// WhammyRecorder.js
        ...
        WhammyRecorder: function (mediaStream) {
...
// WhammyRecorderHelper.js
        ...
        WhammyRecorderHelper: function (mediaStream, root) {
...
// GifRecorder.js
        ...
        GifRecorder: function (mediaStream) {
            var IsEdge = this.IsEdge();
            var IsOpera = this.IsOpera();
            var IsChrome = this.IsChrome();
